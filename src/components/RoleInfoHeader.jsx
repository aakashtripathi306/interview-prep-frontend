...
const RoleInfoHeader = ({
  ...
  return (
    <div className="bg-gray-50 relative"> {/* Light off-white background */}
      <div className="container mx-auto px-10 md:px-0">
        <div className="h-[200px] flex flex-col justify-center relative z-10">
          <div className="flex items-start">
            <div className="flex-grow">
              <div className="flex justify-between items-start">
                <div>
                  <h2 className="text-2xl font-medium text-gray-800">{role}</h2>
          ...
          <div className="flex items-center gap-3 mt-4">
            <div className="text-[10px] font-semibold text-gray-700 bg-indigo-100 px-3 py-1 rounded-full">
              Experience: {experience}
              {experience == 1 ? ` Year` : ` Years`}
            </div>
            <div className="text-[10px] font-semibold text-gray-700 bg-teal-100 px-3 py-1 rounded-full">
              {questions} Q&A
            </div>
            <div className="text-[10px] font-semibold text-gray-700 bg-purple-100 px-3 py-1 rounded-full">
